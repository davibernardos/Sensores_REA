...
public class ImageResizeUtils {
    ...
    private static final String TAG =
            ImageResizeUtils.class.getName();

    public static Bitmap getResizedImageResource(Context context,
                                                 int resImgId,
                                                 int width,
                                                 int height) {
        try {
            // Configura o BitmapFactory para ler o tamanho da imagem
            // (sem carregá-la em memória)
    ...
    public static Bitmap getResizedImage(Uri uriFile,
                                         int width,
                                         int height) {
        return getResizedImage(uriFile,
                width,
                height,
                false);
    }
    ...
    public static Bitmap getResizedImage(Uri uriFile,
                                         ...
                                         boolean fixMatrix) {
        try {
            // ConfiguraBitmapFactory para ler o tamanho da imagem
            // (sem carregá-la em memória)
    ...
    private static Bitmap fixMatrix(Uri uriFile,
